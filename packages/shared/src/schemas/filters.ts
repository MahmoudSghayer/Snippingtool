...
export const createSavedFilterRequestSchema = z
  .object({
    name: z.string().min(1).max(80),
    filter: filterCriteriaSchema,
  })
...
export const updateSavedFilterRequestSchema = z
  .object({
 ...
 */
export const filterStatsSchema = z
  .object({
...
export const reportFilterStatsRequestSchema = z
  .object({
