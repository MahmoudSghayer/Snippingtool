...
import { DropdownMenu, DropdownMenuContent, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger, EmptyState, IconButton } from '@sl/ui';
import { formatRelativeTime } from '@sl/ui';
...
export function NotificationsBell() {
  ...
  const { data } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await api.GET('/notifications', { params: { query: { limit: 10 } } });
